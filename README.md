...
Данный проект является некоммерческой модификацией для устаревшей версии игры World of Tanks (0.6.1.5), созданной исключительно в ознакомительных и исследовательских целях.
...
This project is a non-commercial modification for the legacy version of World of Tanks (0.6.1.5), created solely for educational and research purposes.
